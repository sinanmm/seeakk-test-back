...
import platformRoutes from './routes/Internal/platformRoutes';
...
import customPipelineRoutes from './modules/dashboard/customPipeline.routes';
...
app.use('/api/internal/platform', platformRoutes);
...
app.use('/api/dashboard', customPipelineRoutes);
